            ...
            <div class="sub-header">
                <div class="top-nav">
                    ...
                    <ul>
                        ...
                        <li><a href="labassistant.jsp">Lab Assistant</a>
                        <li><a href="lab.jsp">Lab</a></li>
                        <!--<li><a href="dept.jsp">Department</a></li>-->
                        <li>   <a href="course.jsp">Course</a></li>
                        <li><a href="adminsystemview.jsp">System</a></li>
                        <li>  <a href="adminstudentv.jsp">Students</a></li>
                        <li>  <a href ="actreport.jsp">Activity Report</a></li>
